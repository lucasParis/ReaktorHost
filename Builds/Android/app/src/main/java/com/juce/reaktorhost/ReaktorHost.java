...
//==============================================================================
public class ReaktorHost   extends Activity
{
    //==============================================================================
    static
    {
    ...
    public MidiDeviceManager getAndroidMidiDeviceManager()
    {
        ...
        synchronized (ReaktorHost.class)
        {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            ReaktorHost.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton (okButtonText.isEmpty() ? "OK" : okButtonText, new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            ReaktorHost.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            ReaktorHost.this.alertDismissed (callback, 2);
                        }
                    })
